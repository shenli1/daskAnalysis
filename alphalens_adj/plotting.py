...
def plotting_context(context='notebook', font_scale=1.5, rc=None):
    """
    Create alphalens_adj default plotting style context.
    ...
    Example
    -------
    with alphalens_adj.plotting.plotting_context(font_scale=2):
        alphalens_adj.create_full_tear_sheet(..., set_context=False)
...
def axes_style(style='darkgrid', rc=None):
    """Create alphalens_adj default axes style context.
    ...
    Example
    -------
    with alphalens_adj.plotting.axes_style(style='whitegrid'):
        alphalens_adj.create_full_tear_sheet(..., set_context=False)
...
def plot_quantile_statistics_table(factor_data):
    ...
    quantile_stats['avg_return'] = factor_data.groupby('factor_quantile') \
        .agg(['mean'])['1D']
